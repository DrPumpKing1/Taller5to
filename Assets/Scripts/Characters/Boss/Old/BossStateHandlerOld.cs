...
public class BossStateHandlerOld : MonoBehaviour
{
    public static BossStateHandlerOld Instance;
    ...
    {
        BossPhaseHandlerOld.OnFirstPhaseStart += BossPhaseHandler_OnFirstPhaseStart;
        BossPhaseHandlerOld.OnPhaseChange += BossPhaseHandler_OnPhaseChange;
        BossPhaseHandlerOld.OnLastPhaseEnded += BossPhaseHandler_OnLastPhaseEnded;

        BossObjectDestructionOld.OnBossAllProjectionGemsLocked += BossPlatformDestruction_OnBossDestroyedAllObjects;
    }
    ...
    private void BossPhaseHandler_OnPhaseChange(object sender, BossPhaseHandlerOld.OnPhaseChangeEventArgs e)
    {
