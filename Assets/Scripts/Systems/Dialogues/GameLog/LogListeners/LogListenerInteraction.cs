...
public class LogListenerInteraction : MonoBehaviour
{
    ...
    private void CommonInteractableElement_OnCommonInteractableElementInteracted(object sender, CommonInteractableElement.OnCommonInteractableElementInteractedEventArgs e) => GameLogManager.Instance.Log($"Interaction/VisualInteractableElementInteracted/{e.id}");
