...
public class ShowcaseRoomBeamPlatformTargetVFXHandler : MonoBehaviour
{
    [Header("Components")]
    ...
    private void OnEnable()
    {
        ...
        ShowcaseRoomBeam.OnBeamPlatformTargetCleared += ShowcaseRoomBeam_OnBeamPlatformTargetCleared;
    ...
    private void ShowcaseRoomBeam_OnBeamPlatformTargetCleared(object sender, ShowcaseRoomBeam.OnBeamPlatformTargetEventArgs e)
    {
        StopPlatformVFX();
