...
public class VisualInteractableElement : MonoBehaviour, IInteractable
{
    [Header("Identifiers")]
    ...
    public static event EventHandler<OnVisualInteractableElementInteractedEventArgs> OnVisualInteractableElementInteracted;

    public class OnVisualInteractableElementInteractedEventArgs : EventArgs
    {
        public int id;
    }
    ...
    {
        OnVisualInteractableElementInteracted?.Invoke(this, new OnVisualInteractableElementInteractedEventArgs { id = id });
    }
}
