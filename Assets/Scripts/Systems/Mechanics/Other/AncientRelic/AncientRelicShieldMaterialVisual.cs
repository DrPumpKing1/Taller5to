...
public class AncientRelicShieldMaterialVisual : MonoBehaviour
{
    [Header("Components")]
    [SerializeField] private AncientRelicShield ancientRelicShield;
    ...
    {
        ancientRelicShield.OnThisAncientRelicShieldPowered += AncientRelicShield_OnThisAncientRelicShieldPowered;
        ancientRelicShield.OnThisAncientRelicShieldDepowered += AncientRelicShield_OnThisAncientRelicShieldDePowered;
    }

    private void OnDisable()
    {
        ancientRelicShield.OnThisAncientRelicShieldPowered -= AncientRelicShield_OnThisAncientRelicShieldPowered;
        ancientRelicShield.OnThisAncientRelicShieldPowered -= AncientRelicShield_OnThisAncientRelicShieldDePowered;
    }
    ...
    private void AncientRelicShield_OnThisAncientRelicShieldPowered(object sender, System.EventArgs e)
    {
    ...
    private void AncientRelicShield_OnThisAncientRelicShieldDePowered(object sender, System.EventArgs e)
    {
