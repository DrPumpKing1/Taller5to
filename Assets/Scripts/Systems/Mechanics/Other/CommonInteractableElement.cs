...
public class CommonInteractableElement : MonoBehaviour, IInteractable
{
    [Header("Identifiers")]
    ...
    public static event EventHandler<OnCommonInteractableElementInteractedEventArgs> OnCommonInteractableElementInteracted;
    ...
    {
        OnCommonInteractableElementInteracted?.Invoke(this, new OnCommonInteractableElementInteractedEventArgs { id = id });
    }
}
