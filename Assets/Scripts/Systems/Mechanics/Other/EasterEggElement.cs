...
public class EasterEggElement : MonoBehaviour, IInteractable
{
    [Header("Identifiers")]
    ...
    public static event EventHandler<OnEasterEggElementInteractedEventArgs> OnEasterEggElementInteracted;

    public class OnEasterEggElementInteractedEventArgs : EventArgs
    {
        public int id;
    }
    ...
    {
        OnEasterEggElementInteracted?.Invoke(this, new OnEasterEggElementInteractedEventArgs { id = id });
    }
}
