...
public class DevMenuOpeningManager : MonoBehaviour
{
    ...
    private void CheckOpenCloseDevMenu()
    {
        ...
        {
            if (UIManager.Instance.GetUILayersCount() != 1) return; //If count is 1, the active layer is the DevMenuUI, this script should not have a refference to the DevMenuUI
